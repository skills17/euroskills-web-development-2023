...
export class CreateBillingQuotasTable1691092241007 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`workspaces\` ADD CONSTRAINT \`FK_bc02d89a5cbb742925cda902c5b\` FOREIGN KEY (\`billing_quota_id\`) REFERENCES \`billing_quotas\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }
