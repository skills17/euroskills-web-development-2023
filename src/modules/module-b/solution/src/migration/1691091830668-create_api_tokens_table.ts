...
export class CreateApiTokensTable1691091830668 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`api_tokens\` ADD CONSTRAINT \`FK_9c644dd21cac1a0e8fca9443373\` FOREIGN KEY (\`workspace_id\`) REFERENCES \`workspaces\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }
