...
class ReservationTest extends WriteTest
{
    ...
    {
        $res1 = $this->client->post('api/v1/concerts/2/shows/2/reservation', [
            'headers' => [
        ...
        $res2 = $this->client->post('api/v1/concerts/2/shows/2/reservation', [
            'headers' => [
                'Content-Type' => 'application/json',
            ],
            'json' => [
    ...
    {
        $seatingBefore = $this->client->get('api/v1/concerts/2/shows/2/seating');
        $this->testReservationCreation();
        $seatingAfter = $this->client->get('api/v1/concerts/2/shows/2/seating');
        ...
        $this->assertJsonResponseEqualsIgnoringOrder($seatingBefore, [
            'rows' => [
                ...
                ['id' => 53, 'name' => 'C', 'seats' => ['total' => 15, 'unavailable' => []]],
        ...
        $this->assertJsonResponseEqualsIgnoringOrder($seatingAfter, [
            'rows' => [
                ...
                ['id' => 58, 'name' => 'H', 'seats' => ['total' => 16, 'unavailable' => []]],
                ['id' => 59, 'name' => 'I', 'seats' => ['total' => 15, 'unavailable' => [2]]],
                ['id' => 60, 'name' => 'J', 'seats' => ['total' => 16, 'unavailable' => [1, 2]]],
                ['id' => 61, 'name' => 'K', 'seats' => ['total' => 15, 'unavailable' => [14, 15]]],
                ['id' => 62, 'name' => 'L', 'seats' => ['total' => 16, 'unavailable' => [13, 14, 15, 16]]],
                ['id' => 63, 'name' => 'M', 'seats' => ['total' => 15, 'unavailable' => []]],
                ['id' => 64, 'name' => 'N', 'seats' => ['total' => 16, 'unavailable' => []]],
            ],
    ...
    {
        $res = $this->client->post('api/v1/concerts/2/shows/2/reservation', [
            'headers' => [
                'Content-Type' => 'application/json',
            ],
            'json' => [
        ...
        $seatingNow = $this->client->get('api/v1/concerts/2/shows/2/seating');
        $this->assertJsonResponseEqualsIgnoringOrder($seatingNow, [
            'rows' => [
                ...
                ['id' => 59, 'name' => 'I', 'seats' => ['total' => 15, 'unavailable' => [2]]],
                ['id' => 60, 'name' => 'J', 'seats' => ['total' => 16, 'unavailable' => []]],
                ['id' => 61, 'name' => 'K', 'seats' => ['total' => 15, 'unavailable' => [3]]],
                ['id' => 62, 'name' => 'L', 'seats' => ['total' => 16, 'unavailable' => [13, 14, 15, 16]]],
                ['id' => 63, 'name' => 'M', 'seats' => ['total' => 15, 'unavailable' => []]],
                ['id' => 64, 'name' => 'N', 'seats' => ['total' => 16, 'unavailable' => []]],
            ],
        ...
        sleep(5);
        $seatingAfterDelay = $this->client->get('api/v1/concerts/2/shows/2/seating');
    ...
    public function testReservationOfUnavailableSeats()
    {
        ...
        $res3 = $this->client->post('api/v1/concerts/2/shows/2/reservation', [
            'headers' => [
                'Content-Type' => 'application/json',
            ],
            'json' => [
        ...
        $res4 = $this->client->post('api/v1/concerts/2/shows/2/reservation', [
            'headers' => [
                'Content-Type' => 'application/json',
            ],
            'json' => [
        ...
        $this->assertJsonResponseStrictEquals($res4, [
            'error' => 'Validation failed',
            'fields' => [
                'reservations' => 'Seat 10 in row 63 is already taken.',
            ],
        ]);
    }
    ...
    public function testReservationReplacement()
    {
        ...
        $seating1 = $this->client->get('api/v1/concerts/2/shows/2/seating');
        $this->assertJsonResponseEqualsIgnoringOrder($seating1, [
            'rows' => [
                ...
                ['id' => 61, 'name' => 'K', 'seats' => ['total' => 15, 'unavailable' => []]],
                ['id' => 62, 'name' => 'L', 'seats' => ['total' => 16, 'unavailable' => [13, 14, 15, 16]]],
                ['id' => 63, 'name' => 'M', 'seats' => ['total' => 15, 'unavailable' => [1, 2]]],
                ['id' => 64, 'name' => 'N', 'seats' => ['total' => 16, 'unavailable' => []]],
            ],
        ]);

        // replace reservation with fewer seats in different row
        $resReplaced1 = $this->client->post('api/v1/concerts/2/shows/2/reservation', [
            'headers' => [
                'Content-Type' => 'application/json',
            ],
            'json' => [
        ...
        $this->assertJsonResponseEqualsIgnoringOrder($seating1, [
            'rows' => [
                ...
                ['id' => 61, 'name' => 'K', 'seats' => ['total' => 15, 'unavailable' => []]],
                ['id' => 62, 'name' => 'L', 'seats' => ['total' => 16, 'unavailable' => [13, 14, 15, 16]]],
                ['id' => 63, 'name' => 'M', 'seats' => ['total' => 15, 'unavailable' => [5]]],
                ['id' => 64, 'name' => 'N', 'seats' => ['total' => 16, 'unavailable' => []]],
            ],
        ]);

        // replace reservation with more seats in different row
        $resReplaced2 = $this->client->post('api/v1/concerts/2/shows/2/reservation', [
            'headers' => [
                'Content-Type' => 'application/json',
            ],
            'json' => [
        ...
        // check if the reserved seats are changed in the seating
        $seating2 = $this->client->get('api/v1/concerts/2/shows/2/seating');
        $this->assertJsonResponseEqualsIgnoringOrder($seating2, [
            'rows' => [
                ...
                ['id' => 61, 'name' => 'K', 'seats' => ['total' => 15, 'unavailable' => []]],
                ['id' => 62, 'name' => 'L', 'seats' => ['total' => 16, 'unavailable' => [13, 14, 15, 16]]],
                ['id' => 63, 'name' => 'M', 'seats' => ['total' => 15, 'unavailable' => [10, 11, 12]]],
                ['id' => 64, 'name' => 'N', 'seats' => ['total' => 16, 'unavailable' => []]],
            ],
        ]);
    }
    ...
    public function testReservationDeletion()
    {
        ...
        $this->assertJsonResponseEqualsIgnoringOrder($seating1, [
            'rows' => [
                ...
                ['id' => 62, 'name' => 'L', 'seats' => ['total' => 16, 'unavailable' => [13, 14, 15, 16]]],
                ['id' => 63, 'name' => 'M', 'seats' => ['total' => 15, 'unavailable' => []]],
                ['id' => 64, 'name' => 'N', 'seats' => ['total' => 16, 'unavailable' => [1, 2]]],
            ],
        ]);

        // delete reservation
        $resDelete = $this->client->post('api/v1/concerts/2/shows/2/reservation', [
            'headers' => [
                'Content-Type' => 'application/json',
            ],
            'json' => [
    ...
    public function testReservationTokenOnOtherShow()
    {
        ...
        $this->assertJsonResponseEqualsIgnoringOrder($seatingShow2, [
            'rows' => [
                ...
                ['id' => 62, 'name' => 'L', 'seats' => ['total' => 16, 'unavailable' => [13, 14, 15, 16]]],
                ['id' => 63, 'name' => 'M', 'seats' => ['total' => 15, 'unavailable' => []]],
                ['id' => 64, 'name' => 'N', 'seats' => ['total' => 16, 'unavailable' => [3, 4]]],
            ],
        ]);
        ...
        $resShow4 = $this->client->post('api/v1/concerts/2/shows/4/reservation', [
            ...
            'json' => [
                'reservation_token' => $resShow2Data['reservation_token'],
                'reservations' => [
                    [
                        'row' => 89,
                        'seat' => 3,
        ...
        $this->assertEquals($resShow2Data['reservation_token'], $resShow4Data['reservation_token'], 'Expected "reservation_token" to not change but got a different one.');

        // reservation should still be there for show 2
        $seatingShow2 = $this->client->get('api/v1/concerts/2/shows/2/seating');
        $this->assertJsonResponseEqualsIgnoringOrder($seatingShow2, [
            'rows' => [
                ['id' => 51, 'name' => 'A', 'seats' => ['total' => 15, 'unavailable' => [7]]],
        ...
        // reservation should now also be there for show 4
    ...
    public function testReservationValidationReservations()
    {
        ...
        $resLargeSeat = $this->client->post('api/v1/concerts/1/shows/1/reservation', [
            'headers' => [
                'Content-Type' => 'application/json',
            ],
            'json' => [
        ...
        $this->assertResponseCode($resLargeSeat, 201);
        ...
        $this->assertJsonResponseStrictEquals($resInexistentRow, [
            'error' => 'Validation failed',
            'fields' => [
                'reservations' => 'Seat 1 in row 1581 is invalid.',
            ],
        ]);
    }
    ...
    {
        $res = $this->client->post('api/v1/concerts/21/shows/4/reservation', [
            'headers' => [
                'Content-Type' => 'application/json',
            ],
            'json' => [
    ...
    {
        $res = $this->client->post('api/v1/concerts/2/shows/41/reservation', [
            'headers' => [
                'Content-Type' => 'application/json',
            ],
            'json' => [
    ...
    {
        $res = $this->client->post('api/v1/concerts/1/shows/2/reservation', [
            'headers' => [
                'Content-Type' => 'application/json',
            ],
            'json' => [
