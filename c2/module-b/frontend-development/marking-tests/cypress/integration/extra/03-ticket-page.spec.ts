import {concertsMockResponse, ticketsMockResponse} from "./extraFixtures";
    ...
    describe('03 Ticket Page', () => {
        ...
        it('Cancel Ticket', () => {
            ...
            cy.wait('@post-cancel-1').its('request.body').should(interception => {
                expect(interception).to.deep.eq({name: 'stubbed_bookee_name1', code: 'stubbed_code1'});
            });
            ...
            cy.wait('@post-cancel-2').its('request.body').should(interception => {
                expect(interception).to.deep.eq({name: 'stubbed_bookee_name2', code: 'stubbed_code2'});
            });
