...
context('Extra', () => {
    describe('01 Landing Page', () => {
        ...
        function expectAllShows() {
            ...
            expectShow(2, concert2Show2, concert2);
            expectShow(3, concert1Show2, concert1);
            expectShow(4, concert3Show1, concert3);
            expectShow(5, concert3Show2, concert3);
        }
        ...
        describe('Filters', () => {
            ...
            it('Date', () => {
                ...
                cy.get('input[type=date]').type(concert1Show1.start.substring(0, 10));
                expectShow(0, concert1Show1, concert1);
                cy.contains('.card:visible', concert2Show2.start.substring(11, 16)).should('not.exist');
                concertsMockResponse.concerts
                    .filter(concert => concert.location.name !== concert1.location.name)
                    .forEach(concert => cy.contains('.card:visible', concert.location.name).should('not.exist'));
                concertsMockResponse.concerts
                    .filter(concert => concert.artist !== concert1.artist)
